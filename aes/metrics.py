"""Evaluation metrics of AES project.

Copyright Note:
    These evaluation metrics are copied from ASAP-AES repository
    (see https://github.com/benhamner/ASAP-AES), sources codes
    are under BSD 2-clause "Simplified" License.
"""
